...
public class PowerButtonService extends Service{
    ...
    public void onCreate() {
        ...
        Log.d(LoggedInActivity.TAG, "PowerButtonService created");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.getBooleanExtra(MyReceiver.SOS_TRIGGERED, false)) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                ...
                Log.d(LoggedInActivity.TAG, "Starting SOS Service...");
    ...
    public void onDestroy() {
        ...
        Log.d(LoggedInActivity.TAG, PowerButtonService.class.getSimpleName() + " destroyed");
    }
