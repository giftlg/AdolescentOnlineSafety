...
public class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (intent.getAction()) {
                case ACTION_SMS_SENT:
                    ...
                    Log.d(LoggedInActivity.TAG, "SOS Message Sent");
                ...
                case ACTION_SMS_DELIVERED:
                    ...
                    Log.d(LoggedInActivity.TAG, "SOS Message Delivered");
        ...
        private void doPowerButtonCount(Context context) {
            ...
            if (mCount == 0 && mTimeStamp == 0) {
                ...
                if ( (ts - mTimeStamp) <= 3 ) {
                    ...
                    Log.d(LoggedInActivity.TAG, "Going towards...");

                    mCount++;
                }
                else {
                    // Cancel the operation
                    Log.d(LoggedInActivity.TAG, "ABORTED!!!");
        ...
        private void initCounter(long ts) {
            ...
            Log.d(LoggedInActivity.TAG, "Counting starts...");
        }
