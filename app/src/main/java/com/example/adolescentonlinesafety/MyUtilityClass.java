...
public class MyUtilityClass {
        ...
        public MyUtilityClass(final Context mContext) {
            ...
            mLocationCallback = new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    Log.d(LoggedInActivity.TAG, location.toString());
        ...
        public void startSOSProcess() {
            ...
            Log.d(LoggedInActivity.TAG, emgContacts + "");
        ...
        private void initProcess() {
            ...
            Log.d(LoggedInActivity.TAG, Arrays.toString(phoneNumbers));
        ...
        private void sendSMS(String mapUrl,  String[] phNo) {
            ...
            Log.d(LoggedInActivity.TAG, smsBody);
